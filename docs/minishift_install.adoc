...
> Note: Make sure you have setup proper virtualization environment: 
https://docs.openshift.org/latest/minishift/getting-started/setting-up-virtualization-environment.html#setting-up-xhyve-driver
